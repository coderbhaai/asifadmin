<div class="container contact py-12">
    ...
    <h2 class="text-xl md:text-3xl font-semibold text-center">Location</h2>
    <div class="flex items-center grid grid-cols-12 gap-4 overflow-hidden py-12">
        ...
        <div class="col-span-12 md:col-span-3 bright">
            ...
            <p class="text-center">(91) 98214 12005</p>
        </div>
        <div class="col-span-12 md:col-span-3 bright">
            ...
            <p class="text-center">aminaboutique247@gmail.com</p>
        </div>
    ...
    <div class="flex items-center grid grid-cols-12 gap-4 overflow-hidden py-12">
        <div class="col-span-12 md:col-span-6 h-full py-5">
            <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=WEST%20PUNJABI%20BAGH%20%2C%20NEW%20DELHI%2C%20India&amp;t=m&amp;z=10&amp;output=embed&amp;iwloc=near" title="%3$s" aria-label="%3$s"></iframe>
        </div>
