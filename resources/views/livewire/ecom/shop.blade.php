                ...
                <div class="bg-white rounded-lg shadow-2xl overflow-hidden amitShadow">
                    ...
                    <div class="p-3">
                        ...
                        <div class="flex sm:block lg:flex items-center justify-between sm:text-center">
                            ...
                            <a href="/product/{{$i->url}}" class="border-2 border-action relative overflow-hidden uppercase z-50 inline-block text-center text-white px-3 py-1 text-xs rounded-lg sm:inline-block bg-action group-hover:bg-white group-hover:text-action transform transition duration-500">Read More</a> 
                        </div>
                    </div>
                </div>
            </div>
