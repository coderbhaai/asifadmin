<div class="container.admin mb-10">
    <div class="flex grid grid-cols-12 gap-4 gap-x-3">
        ...
        <div class="col-span-12 md:col-span-10 px-3 md:pt-10">
            <h1 class="text-center text-3xl font-bold py-2 mb-6">Admin Orders </h1>
            ...
            <table class="min-w-full table-auto mb-5">
                ...
                <tr class="bg-primary">
                    ...
                    <th class="py-2 relative hover:cursor-pointer"><span class="text-white">Amount | Discount</span> </th>
                ...
                <div class="relative sm:w-3/4 mx-2 sm:mx-auto my-10 opacity-100">
                    ...
                    x-transition:enter="transition transform duration-300" x-transition:enter-start="scale-0" x-transition:enter-end="scale-100" x-transition:leave="transition transform duration-300" x-transition:leave-start="scale-100" x-transition:leave-end="scale-0">
                        <header class="flex items-center justify-between p-2">
                            <h2 class="font-semibold">Update Order Here</h2>
                        ...
                        <main class="p-2">
                                ...
                                <div class="bg-white">
                                    <div class="grid grid-cols-12 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <select class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" wire:model="status">
                                        ...
                                        <div class="col-span-12">
                                            ...
                                            <textarea type="text" wire:model="remarks" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Add remarks"></textarea>
                            ...
                            <p>Buyer<br/> Name : {{$address[0]}} | Email : {{$address[1]}} | Phone : {{$address[2]}}</p>
                            <p>Address : {{$address[6]}}, {{$address[5]}}, {{$address[4]}}, {{$address[3]}}, PIN - {{$address[7]}}</p>
                        </main>
                    </div>
                </div>
            </div>
