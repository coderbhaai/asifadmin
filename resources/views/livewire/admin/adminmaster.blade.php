        ...
        <div class="col-span-12 md:col-span-10 px-3 md:pt-10">
            ...
            <table class="min-w-full table-auto mb-5">
                ...
                <tr class="bg-primary">
                    ...
                    <th class="py-2 relative hover:cursor-pointer" wire:click="sortBy('tab1')"><span class="text-white">Tab1</span> @include('partials.sorticon', ['field'=>'tab1']) </th>
                ...
                <tbody class="">
                    @foreach($data as $i)
                        <tr class="">
                            ...
                            <td class="px-1 py-1 text-sm">{{$i->tab1}}</td>
