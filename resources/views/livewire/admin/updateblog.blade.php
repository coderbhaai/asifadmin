<div class="container.admin mb-10">
    ...
    <div class="flex grid grid-cols-12 gap-4 gap-x-3">
        ...
        <div class="col-span-10 px-3 pt-10">
            <h1 class="text-center text-3xl font-bold py-2 mb-6">Update Blog </h1>
                ...
                <div class="bg-white">
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            @error('url') <span class="error text-action font-bold" ...>{{ $message }}</span> @enderror
                        </div>
                        <div class="col-span-6">
                        ...
                        <div class="col-span-12">
                            <label for="title" class="block text-sm font-medium text-gray-700">Meta Title - {{ strlen( $title ) }}</label>
                            ...
                            @error('title') <span class="error text-action font-bold" ...>{{ $message }}</span> @enderror
                        </div>
                        <div class="col-span-12">
                            <label for="description" class="block text-sm font-medium text-gray-700">Meta Description - {{ strlen( $description ) }}</label>
                            ...
                            @error('description') <span class="error text-action font-bold" ...>{{ $message }}</span> @enderror
                        </div>
