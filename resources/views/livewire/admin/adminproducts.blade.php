<div class="container.admin">
    <div class="flex grid grid-cols-12 gap-4 gap-x-3">
        ...
        <div class="col-span-12 md:col-span-10 px-3 md:pt-10">
            <h1 class="text-center text-3xl font-bold py-2 mb-6">Admin Products</h1>
            <div class="md:flex justify-between mb-2 md:mb-0">
                <a href="{{ route('addproduct') }}" class="block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Add Product</a>
                <div class="row">
            ...
            <table class="min-w-full table-auto mb-5">
                ...
                <tr class="bg-primary">
                    ...
                    <th class="py-2 relative hover:cursor-pointer" wire:click="sortBy('title')"><span class="text-white">Product</span> @include('partials.sorticon', ['field'=>'title'])</th>
